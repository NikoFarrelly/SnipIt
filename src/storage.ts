...
export const getGlobalState = async (): Promise<GlobalState> => {
  ...
  if (storedGlobalState?.[GLOBAL_STATE_KEY])
    return storedGlobalState[GLOBAL_STATE_KEY] as GlobalState;
...
export const deleteSnips = async (id: string | string[]) =>
